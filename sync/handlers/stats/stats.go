...
func NewHandlerStats(enabled bool) HandlerStats {
	...
	return &handlerStats{
		...
		blocksReturned: metrics.GetOrRegisterHistogram(
			"block_request_total_blocks", nil, metrics.NewExpDecaySample(1028, 0.015),
		),
		...
		codeBytesReturned: metrics.GetOrRegisterHistogram(
			"code_request_bytes_returned", nil, metrics.NewExpDecaySample(1028, 0.015),
		),
		...
		leafsReturned: metrics.GetOrRegisterHistogram(
			"leafs_request_total_leafs", nil, metrics.NewExpDecaySample(1028, 0.015),
		),
		...
		proofValsReturned: metrics.GetOrRegisterHistogram(
			"leafs_request_proof_vals_returned", nil, metrics.NewExpDecaySample(1028, 0.015),
		),
