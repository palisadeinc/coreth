...
func (h *handler) handleCallMsg(ctx *callProc, msg *jsonrpcMessage) *jsonrpcMessage {
	...
	case msg.isNotification():
		...
		h.log.Debug(
			"Served "+msg.Method, "execTime", time.Since(execStart), "procTime", time.Since(procStart), "totalTime",
	...
	case msg.isCall():
		...
		var logctx []any
		logctx = append(
			logctx, "reqid", idForLog{msg.ID}, "execTime", time.Since(execStart), "procTime", time.Since(procStart),
